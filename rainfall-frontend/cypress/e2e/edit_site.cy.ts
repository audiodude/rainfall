describe('Edit Site test', () => {
  ...
  describe('when there is a welcomed user', () => {
    ...
    describe('when there are more than 0 releases', () => {
      beforeEach(() => {
      ...
      describe('when there is a release with an upload', () => {
        ...
        describe('when the preview button is clicked', () => {
          ...
          beforeEach(() => {
            ...
            cy.intercept(
              'GET',
              'api/v1/preview/06547ed8-206f-7d3d-8000-20ab423e0bb9/status',
              async (req) => {
                await new Promise((resolve) => setTimeout(resolve, 250));
                cnt++;
                if (cnt < 3) {
                  req.reply(200, { status: 200, task_status: 'PENDING' });
                } else {
                  req.reply(200, { tatus: 200, task_status: 'SUCCESS' });
                }
              },
            ).as('preview-status');
