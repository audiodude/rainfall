    ...
    <div class="md:max-w-screen-md pl-4 mt-4">
      ...
      <div class="mt-8 max-w-xs mx-auto md:mx-0 text-center md:text-left">
        <button
          @click="getStarted()"
          :disabled="!ready"
          class="get-started cursor-pointer disabled:cursor-auto bg-transparent hover:bg-blue-500 disabled:hover:bg-transparent font-semibold hover:text-white disabled:hover:dark:text-gray-300 py-2 px-4 border border-blue-500 hover:border-transparent disabled:hover:border-blue-500 rounded"
        >
          Get started!
        </button>
      </div>
